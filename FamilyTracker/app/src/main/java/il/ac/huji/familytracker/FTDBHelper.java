...
public class FTDBHelper extends SQLiteOpenHelper {
    ...
    public static final String NOTIFICATION_INSERT_COMMAND = String.format("INSERT INTO %s (%s,%s,%s,%s,%s) VALUES (?,?,?,?,?)", NOTIFICATION_TABLE_NAME, NOTIFICATION_COLUMN_TYPE, NOTIFICATION_COLUMN_COORD, NOTIFICATION_COLUMN_TIME_STAMP, NOTIFICATION_COLUMN_NTF_MGR_ID, NOTIFICATION_COLUMN_SUBJECT_NAME);
    ...
    public static final String[] NOTIFICATION_TABLE_DATA_COLUMNS = {NOTIFICATION_COLUMN_DB_ID, NOTIFICATION_COLUMN_TYPE, NOTIFICATION_COLUMN_COORD, NOTIFICATION_COLUMN_SUBJECT_NAME, NOTIFICATION_COLUMN_TIME_STAMP, NOTIFICATION_COLUMN_NTF_MGR_ID};
