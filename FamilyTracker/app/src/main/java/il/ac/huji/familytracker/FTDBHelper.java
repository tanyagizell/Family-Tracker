...
public class FTDBHelper extends SQLiteOpenHelper {
    ...
    private final String PLACES_TABLE_CREATION = String.format("CREATE TABLE %s (" +
                    ...
                    "%s TEXT NOT NULL," +
                    "%s  TEXT NOT NULL);", PLACES_TABLE_NAME,
    ...
    public static final String MEMBER_TO_FAMILY_TABLE_NAME = "membertoplace";
    public static final String MEMBER_TO_FAMILY_COLUMN_MEMBER_ID = "MEMBER";
    public static final String MEMBER_TO_FAMILY_COLUMN_PLACE_ID = "PLACE";
    public static final String MEMBER_TO_FAMILY_INSERT_COMMAND = String.format("INSERT INTO  %s (%s,%s) VALUES (?,?)", MEMBER_TO_FAMILY_COLUMN_PLACE_ID, MEMBER_TO_FAMILY_COLUMN_MEMBER_ID);
    private static final String DB_NAME = "familytracker.db";
    private static final String NOTIFICATION_COLUMN_DB_ID = "ID";
    ...
    private final String MEMBER_TO_FAMILY_TABLE_CREATION = String.format("CREATE TABLE %s (" +
                    ...
                    "FOREIGN KEY(%s) REFERENCES %s(%s));", MEMBER_TO_FAMILY_COLUMN_REGISTRATION_ID,
            MEMBER_TO_FAMILY_COLUMN_PLACE_ID,
            MEMBER_TO_FAMILY_COLUMN_MEMBER_ID,
            MEMBER_TO_FAMILY_COLUMN_PLACE_ID, PLACES_TABLE_NAME, PLACES_COLUMN_PLACE_ID,
            MEMBER_TO_FAMILY_COLUMN_MEMBER_ID, FAMILY_MEMBERS_TABLE_NAME, FAMILY_MEMBERS_COLUMN_MEMBER_ID);
    public static final String[] MEMBER_TO_FAMILY_DATA_COLUMNS = {MEMBER_TO_FAMILY_COLUMN_REGISTRATION_ID, MEMBER_TO_FAMILY_COLUMN_PLACE_ID, MEMBER_TO_FAMILY_COLUMN_MEMBER_ID};
    private static final int DB_VERSION = 1;
    private static FTDBHelper m_objInstantiatedElement;
